...
<div class="card pt-5px" >
  ...
  <div class="card-body">
    ...
    <a href="heart_data.php" class="btn btn-success">View Hospitals</a>
  </div>
</div>
<br>
<div class="card pt-5px" >
  ...
  <div class="card-body">
    ...
    <a href="cancer_data.php" class="btn btn-success">View Hospitals</a>
  </div>
</div>
<br>
<div class="card pt-5px" >
  ...
  <div class="card-body">
    ...
    <p class="card-text">Dr.E Borges Road ,Parel,Mumbai</p>
    <p>#Offers free Treatment to over 70% Cancer Patients</p>
    <a href="eye_data.php" class="btn btn-success">View Hospitals</a>
  </div>
</div>
  <!-- card ends-->
